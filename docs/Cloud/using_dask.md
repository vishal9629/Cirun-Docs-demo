...
<!-- ![Nebari - Cluster Options UI](/img/Cloud/cluster_options.png) -->
...
1. Let's start by creating a new Dask cluster from within your notebook:
   ...
   <!-- ![Creating a Gateway Cluster UI](/img/Cloud/cluster_creation.png) -->
...
<!-- ![Nebari - Dask client UI showing details of the newly created Dask cluster](/img/Cloud/dask_client.png) -->
...
<!-- ![Dask diagnostic UI -  showing four parallel computation streams](/img/Cloud/dask_diagostic_UI.png) -->
...
<!-- ![Dask-labextension UI In JupyterLab -  displays the demo notebook and a list of cluster settings](/img/Cloud/dask_labextension.png) -->
